 ...
 * @author rahul
 */
public class AdminLogin implements MyInterface{
    public void entry(HttpServletRequest request,HttpServletResponse response,ServletContext context){
        ...
        try {
            ...
            if( utype==1){
                if( status==1){
                   // request.getRequestDispatcher("controller?command=AddLogin&case=2").forward(request,response);
                ...
                if(status==1){
                    ...
                    if(display.equals("1")){
                        ...
                        //con.commit();
                        System.out.println("sdfsadfasfasdf");
                        request.getRequestDispatcher("controller?command=FullBlog&case=2&id="+blog_id).include(request,response);
                    }else{
                        System.out.println("hii133");
